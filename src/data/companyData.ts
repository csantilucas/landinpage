...
export const PRODUCTS_SERVICES: ProductService[] = [
  ...
  },
  {
    ...
    tagline: "Seu próprio posto de abastecimento dentro da sua fazenda ou pátio",
    description: "Disponibilizamos tanques aéreos metálicos certificados, bombas medidoras digitais calibradas e bacias de contenção ambiental sem que você precise imobilizar capital em infraestrutura.",
    features: [
      "Capacidades de 5.000 a 30.000 litros por módulo",
      "Bomba medidora de alta vazão com bico automático",
      "Adequação técnica às normas ambientais e ANP/NR-20"
    ],
    idealFor: "Produtores rurais com safra ativa e frotistas com pátio central.",
    badge: "Solução Chave na Mão"
  },
  {
    id: "lubrificantes",
...
export const COMPANY_METRICS = [
  ...
  { value: "+100M", label: "Litros Entregues", subtext: "Histórico de confiança no Agro e Logística" },
